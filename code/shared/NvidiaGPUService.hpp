#ifndef RF_SYSTEM_DIAGNOSTICS_PROFILING_NVIDIAGPUSERVICE_HPP
#define RF_SYSTEM_DIAGNOSTICS_PROFILING_NVIDIAGPUSERVICE_HPP
#if _MSC_VER > 1000
#pragma once
#endif
...
class NvidiaGPUService: public RF_Prof::GPUService
{
public:
    NvidiaGPUService(const RF_Type::String& Name);
    virtual ~NvidiaGPUService()override;
...
#endif //!RF_SYSTEM_DIAGNOSTICS_PROFILING_NVIDIAGPUSERVICE_HPP